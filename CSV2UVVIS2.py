...
def process_data():
    ...
    for i, df in enumerate(data_frames):
        ...
        ax.scatter(max_lambda, max_abs, color='black', zorder=1, s=5)
    ...
    ax.set_ylabel('Absorbansi')  # Sumbu y
...
# Input judul grafik
Label(root, text="Judul Grafik:").grid(row=2, column=0, padx=10, pady=5, sticky="w")
...
credit_label = Label(root, text="Made with ❤️ by Rynn ~ personal use for physics of materials", font=("Arial", 8), fg="gray")
