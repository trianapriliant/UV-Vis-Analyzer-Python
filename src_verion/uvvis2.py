...
# Menghitung nilai absorbansi tertinggi pada sampel pertama dan terakhir
abs_max_sampel_pertama = data_frames[0]['Absorbansi'].max()
abs_max_sampel_terakhir = data_frames[-1]['Absorbansi'].max()

# Menghitung persentase degradasi
