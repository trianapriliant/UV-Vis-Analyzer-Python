...
def process_data():
    ...
    graph_title = graph_title_var.get() if graph_title_var.get() else "Hubungan Lambda dengan Absorbansi"
    ...
    ax.set_xlabel('Lambda (nm)', fontname='Times New Roman', fontsize=12)
    ax.set_ylabel('Absorbansi', fontname='Times New Roman', fontsize=12)
    ax.set_title(graph_title, fontname='Times New Roman', fontsize=14)  # Menggunakan font Times New Roman
    ax.legend(fontsize=10, fontname='Times New Roman')
    ax.grid(True)
...
credit_label = Label(root, text="Made with ❤️ by Rynn ~ personal use for physics of materials", font=("Arial", 10), fg="gray")
