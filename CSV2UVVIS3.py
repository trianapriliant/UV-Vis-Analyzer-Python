...
Radiobutton(root, text="Absorbansi", variable=plot_type, value=1).grid(row=3, column=0, padx=10, pady=5, sticky="w")
Radiobutton(root, text="Transmitansi", variable=plot_type, value=2).grid(row=3, column=1, padx=10, pady=5, sticky="w")
